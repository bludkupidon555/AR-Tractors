...
public class SetLRuB : MonoBehaviour
{
    ...
    void SetLanguageFunction()
    {
        ...
        if (Database.connection.State == ConnectionState.Open)
        {
            ...
            Database.cmd.CommandText = "UPDATE SelectedLanguageTable SET SelectedLanguage = 'Ru' WHERE SelectedLanguage = 'En'";
        ...
        SelectedLanguage.text = LanguageList[12] + Environment.NewLine + Environment.NewLine + "<color='green'>Русский</color>";
    }
}
